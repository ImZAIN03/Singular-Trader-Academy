...
const Training = () => {
  return (
    <div className="flex flex-col mt-5 mb-16 md:flex-row">
      {/* Image section for small screens */}
      <div className="md:hidden w-full">
        <img src="https://smashcode-singular-trader.web.app/static/media/laptop.19f6d78b46aafd92bcfd.png" alt="The Image" className="h-100 w-full object-contain" />
      </div>

      {/* Text section */}
      <div className="bg-cover bg-center text-left w-full md:w-1/2 relative">
        <div className="h-full flex items-center text-left justify-center">
          <div className="text-black text-left max-w-md px-4">
